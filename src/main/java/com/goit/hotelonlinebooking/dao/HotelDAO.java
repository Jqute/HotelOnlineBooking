...
public class HotelDAO extends AbstractDAO<Hotel>{
    ...
    private List<Room> roomConstruction() {
        ...
        listOne.add(new Room(new Random().nextLong(), 100, 1,2,null));
        listOne.add(new Room(new Random().nextLong(), 200, 1,2,null));
        listOne.add(new Room(new Random().nextLong(), 300, 1,2,null));
        listOne.add(new Room(new Random().nextLong(), 100, 1,2,null));
        listOne.add(new Room(new Random().nextLong(), 100, 1,2,null));
        listOne.add(new Room(new Random().nextLong(), 100, 1,2,null));
        listOne.add(new Room(new Random().nextLong(), 100, 1,2,null));
        ...
        listTwo.add(new Room(new Random().nextLong(), 200, 1,2,null));
        listTwo.add(new Room(new Random().nextLong(), 200, 1,2,null));
        listTwo.add(new Room(new Random().nextLong(), 200, 1,2,null));
        listTwo.add(new Room(new Random().nextLong(), 200, 1,2,null));
        listTwo.add(new Room(new Random().nextLong(), 100, 1,2,null));
        listTwo.add(new Room(new Random().nextLong(), 100, 1,2,null));
        listTwo.add(new Room(new Random().nextLong(), 300, 1,2,null));
        listTwo.add(new Room(new Random().nextLong(), 300, 1,2,null));
        listTwo.add(new Room(new Random().nextLong(), 300, 1,2,null));
        listTwo.add(new Room(new Random().nextLong(), 300, 1,2,null));

        List<Room> listThree = new ArrayList<>();
        listThree.add(new Room(new Random().nextLong(), 100, 1,2,null));
        listThree.add(new Room(new Random().nextLong(), 100, 1,2,null));
        listThree.add(new Room(new Random().nextLong(), 100, 1,2,null));
        listThree.add(new Room(new Random().nextLong(), 200, 1,2,null));
        listThree.add(new Room(new Random().nextLong(), 200, 1,2,null));
        listThree.add(new Room(new Random().nextLong(), 200, 1,2,null));
        listThree.add(new Room(new Random().nextLong(), 250, 1,2,null));
        listThree.add(new Room(new Random().nextLong(), 250, 1,2,null));
        listThree.add(new Room(new Random().nextLong(), 250, 1,2,null));
        listThree.add(new Room(new Random().nextLong(), 250, 1,2,null));
